...
import net.xbtstudio.school.block.WiFi7routerBlock;
import net.xbtstudio.school.block.WiFi7HGUONTBlock;
import net.xbtstudio.school.block.WiFi6CMONTBlock;
...
import net.xbtstudio.school.block.UrinalBlock;
...
import net.xbtstudio.school.block.ToiletBlock;
...
import net.xbtstudio.school.block.TVDVBBlock;
import net.xbtstudio.school.block.TVBlock;
import net.xbtstudio.school.block.TOSAOBlock;
import net.xbtstudio.school.block.TDSABlock;
...
import net.xbtstudio.school.block.SidewalkBlock;
import net.xbtstudio.school.block.SetsquareblaBlock;
...
import net.xbtstudio.school.block.SSWUBlock;
import net.xbtstudio.school.block.SSWOUBlock;
import net.xbtstudio.school.block.SSWOGBlock;
import net.xbtstudio.school.block.SSWOBlock;
import net.xbtstudio.school.block.SSWGBlock;
import net.xbtstudio.school.block.SSWBlock;
import net.xbtstudio.school.block.SSWBOBlock;
import net.xbtstudio.school.block.SSWBBlock;
...
import net.xbtstudio.school.block.RSBlock;
import net.xbtstudio.school.block.RORHBlock;
...
import net.xbtstudio.school.block.POFBlock;
...
import net.xbtstudio.school.block.PCLONBlock;
import net.xbtstudio.school.block.PCLBlock;
...
import net.xbtstudio.school.block.OrbqBlock;
...
import net.xbtstudio.school.block.OncBlock;
...
import net.xbtstudio.school.block.OicBlock;
import net.xbtstudio.school.block.ORbBlock;
import net.xbtstudio.school.block.ONDeskwithdesktopcomputerBlock;
import net.xbtstudio.school.block.ONCQBlock;
...
import net.xbtstudio.school.block.LTABSWUOBlock;
import net.xbtstudio.school.block.LTABSWUBlock;
import net.xbtstudio.school.block.LTABSWOBlock;
import net.xbtstudio.school.block.LTABSWGOBlock;
import net.xbtstudio.school.block.LTABSWGBlock;
import net.xbtstudio.school.block.LTABSWBlock;
import net.xbtstudio.school.block.LTABSWBOBlock;
import net.xbtstudio.school.block.LTABSWBBlock;
...
import net.xbtstudio.school.block.HPMPCBlock;
import net.xbtstudio.school.block.HPCBlock;
...
import net.xbtstudio.school.block.GPONXGSPONCCOLTBlock;
...
import net.xbtstudio.school.block.FERULBlock;
...
import net.xbtstudio.school.block.CurtainBlock;
...
import net.xbtstudio.school.block.ClassroomirondoorBlock;
...
import net.xbtstudio.school.block.ChoaRrBlock;
...
import net.xbtstudio.school.block.BsaBlock;
import net.xbtstudio.school.block.BroadcastcrewBlock;
import net.xbtstudio.school.block.BrickwallBlock;
...
import net.xbtstudio.school.block.BlackboardlightBlock;
import net.xbtstudio.school.block.BlackBoardBlock;
import net.xbtstudio.school.block.Bipom86tBlock;
import net.xbtstudio.school.block.BillboardsBlock;
import net.xbtstudio.school.block.BalanceBlock;
import net.xbtstudio.school.block.BSARBlock;
import net.xbtstudio.school.block.BOEBlock;
...
import net.xbtstudio.school.block.AeatBlock;
...
public class SchoolModBlocks {
	...
	public static final RegistryObject<Block> BLACK_BOARD_LIGHT = REGISTRY.register("black_board_light", () -> new BlackboardlightBlock());
	public static final RegistryObject<Block> CLASSROOM_IRON_DOOR = REGISTRY.register("classroom_iron_door", () -> new ClassroomirondoorBlock());
	public static final RegistryObject<Block> SETSQUAREBLA = REGISTRY.register("setsquarebla", () -> new SetsquareblaBlock());
	public static final RegistryObject<Block> FERUL = REGISTRY.register("ferul", () -> new FERULBlock());
	public static final RegistryObject<Block> TVDVB = REGISTRY.register("tvdvb", () -> new TVDVBBlock());
	public static final RegistryObject<Block> HPC = REGISTRY.register("hpc", () -> new HPCBlock());
	public static final RegistryObject<Block> AEAT = REGISTRY.register("aeat", () -> new AeatBlock());
	public static final RegistryObject<Block> LAWN = REGISTRY.register("lawn", () -> new LawnBlock());
	public static final RegistryObject<Block> SIDEWALK = REGISTRY.register("sidewalk", () -> new SidewalkBlock());
	public static final RegistryObject<Block> BRICKWALL = REGISTRY.register("brickwall", () -> new BrickwallBlock());
	public static final RegistryObject<Block> POF = REGISTRY.register("pof", () -> new POFBlock());
	public static final RegistryObject<Block> HPMPC = REGISTRY.register("hpmpc", () -> new HPMPCBlock());
	public static final RegistryObject<Block> CHOA_RR = REGISTRY.register("choa_rr", () -> new ChoaRrBlock());
	public static final RegistryObject<Block> CURTAIN = REGISTRY.register("curtain", () -> new CurtainBlock());
	public static final RegistryObject<Block> RRH = REGISTRY.register("rrh", () -> new RrhBlock());
	public static final RegistryObject<Block> RORH = REGISTRY.register("rorh", () -> new RORHBlock());
	public static final RegistryObject<Block> O_RB = REGISTRY.register("o_rb", () -> new ORbBlock());
	public static final RegistryObject<Block> ORBQ = REGISTRY.register("orbq", () -> new OrbqBlock());
	...
	public static final RegistryObject<Block> PCLON = REGISTRY.register("pclon", () -> new PCLONBlock());
	public static final RegistryObject<Block> PCL = REGISTRY.register("pcl", () -> new PCLBlock());
	public static final RegistryObject<Block> SSW = REGISTRY.register("ssw", () -> new SSWBlock());
	public static final RegistryObject<Block> SSWO = REGISTRY.register("sswo", () -> new SSWOBlock());
	public static final RegistryObject<Block> SSWB = REGISTRY.register("sswb", () -> new SSWBBlock());
	public static final RegistryObject<Block> SSWBO = REGISTRY.register("sswbo", () -> new SSWBOBlock());
	public static final RegistryObject<Block> SSWU = REGISTRY.register("sswu", () -> new SSWUBlock());
	public static final RegistryObject<Block> SSWOU = REGISTRY.register("sswou", () -> new SSWOUBlock());
	public static final RegistryObject<Block> SSWG = REGISTRY.register("sswg", () -> new SSWGBlock());
	public static final RegistryObject<Block> SSWOG = REGISTRY.register("sswog", () -> new SSWOGBlock());
	public static final RegistryObject<Block> LTABSW = REGISTRY.register("ltabsw", () -> new LTABSWBlock());
	public static final RegistryObject<Block> LTABSWO = REGISTRY.register("ltabswo", () -> new LTABSWOBlock());
	public static final RegistryObject<Block> LTABSWB = REGISTRY.register("ltabswb", () -> new LTABSWBBlock());
	public static final RegistryObject<Block> LTABSWBO = REGISTRY.register("ltabswbo", () -> new LTABSWBOBlock());
	public static final RegistryObject<Block> LTABSWU = REGISTRY.register("ltabswu", () -> new LTABSWUBlock());
	public static final RegistryObject<Block> LTABSWUO = REGISTRY.register("ltabswuo", () -> new LTABSWUOBlock());
	public static final RegistryObject<Block> LTABSWG = REGISTRY.register("ltabswg", () -> new LTABSWGBlock());
	public static final RegistryObject<Block> LTABSWGO = REGISTRY.register("ltabswgo", () -> new LTABSWGOBlock());
	public static final RegistryObject<Block> URINAL = REGISTRY.register("urinal", () -> new UrinalBlock());
	public static final RegistryObject<Block> TOILET = REGISTRY.register("toilet", () -> new ToiletBlock());
	public static final RegistryObject<Block> TOSAO = REGISTRY.register("tosao", () -> new TOSAOBlock());
	public static final RegistryObject<Block> TDSA = REGISTRY.register("tdsa", () -> new TDSABlock());
	public static final RegistryObject<Block> MLE = REGISTRY.register("mle", () -> new MLEBlock());
	public static final RegistryObject<Block> BSA = REGISTRY.register("bsa", () -> new BsaBlock());
	public static final RegistryObject<Block> BSAR = REGISTRY.register("bsar", () -> new BSARBlock());
	public static final RegistryObject<Block> OIC = REGISTRY.register("oic", () -> new OicBlock());
	public static final RegistryObject<Block> WI_FI_7_HGUONT = REGISTRY.register("wi_fi_7_hguont", () -> new WiFi7HGUONTBlock());
	public static final RegistryObject<Block> WI_FI_7ROUTER = REGISTRY.register("wi_fi_7router", () -> new WiFi7routerBlock());
	public static final RegistryObject<Block> BIPOM_86T = REGISTRY.register("bipom_86t", () -> new Bipom86tBlock());
	public static final RegistryObject<Block> WI_FI_6_CMONT = REGISTRY.register("wi_fi_6_cmont", () -> new WiFi6CMONTBlock());
	public static final RegistryObject<Block> BOE = REGISTRY.register("boe", () -> new BOEBlock());
	public static final RegistryObject<Block> GPONXGSPONCCOLT = REGISTRY.register("gponxgsponccolt", () -> new GPONXGSPONCCOLTBlock());
